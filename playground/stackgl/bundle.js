...
},{"ndarray":7,"ndarray-ops":2,"typedarray-pool":11,"webglew":13}],2:[function(require,module,exports){
"use strict"
...
},{"buffer":30,"iota-array":8}],8:[function(require,module,exports){
"use strict"
...
},{"bit-twiddle":9,"buffer":30,"dup":10}],12:[function(require,module,exports){
...
},{"raf-component":15}],15:[function(require,module,exports){
/**
...
},{"./do-bind.js":16}],18:[function(require,module,exports){
"use strict"
...
},{"./do-bind.js":16}],19:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"dup":12}],20:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13,"weak-map":19}],21:[function(require,module,exports){
"use strict"
...
},{"./lib/vao-emulated.js":17,"./lib/vao-native.js":18,"webglew":20}],22:[function(require,module,exports){
...
},{"gl-shader-core":28}],23:[function(require,module,exports){
module.exports = noop
...
},{"./reflect":26,"dup":27}],26:[function(require,module,exports){
'use strict'
...
},{"./lib/create-attributes":24,"./lib/create-uniforms":25,"./lib/reflect":26}],29:[function(require,module,exports){
...
var shader = require("glslify/adapter.js")("\n#define GLSLIFY 1\n\nprecision highp float;\nattribute vec3 position, color;\nattribute float size;\nvarying vec3 fragColor;\nvoid main() {\n  gl_Position = vec4(position, 1.0);\n  gl_PointSize = size;\n  fragColor = color;\n}", "\n#define GLSLIFY 1\n\nprecision highp float;\nvarying vec3 fragColor;\nvoid main() {\n  gl_FragColor = vec4(fragColor, 1.0);\n}", [], [{"name":"position","type":"vec3"},{"name":"color","type":"vec3"},{"name":"size","type":"float"}])(gl);
var numPoints = 1024;
...
var colorArray = [[1, 1, 1], [0.3451, 1, 0.545], [1, 0.4313, 0.3411], [1, 0.8862, 0.3725], [0.3804, 0.7647, 1]];
var pointer = 0;

for (var i = 0; i < numPoints; ++i) {
    var c = colorArray[Math.random() * colorArray.length | 0];
    vertexSizes[i] = 1 + Math.random() * 32;

    for (var j = 0; j < 3; ++j) {
        vertexPhases[pointer] = Math.random() * 2 * Math.PI;
        vertexFreqs[pointer] = Math.random() * 32;
...
},{"gl-buffer":1,"gl-context":14,"gl-vao":21,"glslify":23,"glslify/adapter.js":22}],30:[function(require,module,exports){
/*!
